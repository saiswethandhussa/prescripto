...
//         <a
//           href="/doctors"
//           className="flex items-center gap-2 bg-white text-primary px-6 py-3 rounded-full text-sm font-medium hover:scale-105 transition-transform"
//         >
//           Book appointment
...
//           alt="doctors"
//           className="w-full md:absolute bottom-0 right-0 max-w-md"
//         />
//       </div>
